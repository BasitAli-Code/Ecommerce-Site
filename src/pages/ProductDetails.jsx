    ...
    <>
      ...
      <div className="my-20 flex flex-col md:flex-row justify-center md:items-start items-center w-full h-auto gap-8 px-4 md:px-12">
        ...
        <div className="flex flex-col w-[90%] md:w-[40%] items-start text-left gap-4">
          <p className="text-[14px] text-gray-600">Home / {product.name}</p>
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <button
              className={`transition-all duration-300 cursor-pointer rounded-md shadow-md px-6 py-2 text-white ${
                isActive ? "bg-red-500" : "bg-[#088178]"
              }`}
              onClick={() => {
                isActive
          ...
          <p className="text-gray-600 text-[16px] leading-relaxed">
            Crafted with quality materials and a modern design, this product
            offers lasting comfort, durability, and everyday style. Perfect for
            daily wear or special occasions, it is designed to match your
            lifestyle with ease.
          </p>
        </div>
      </div>
