    ...
    <>
      ...
      <div className="flex mb-10 items-center justify-center gap-3 w-full h-auto">
        <button
          ...
          className={`transition-all duration-300 cursor-pointer rounded-md shadow-lg px-7 py-4 md:px-6 md:py-3 text-xl hover:bg-[#088178] hover:text-[#fff] ${
            isActive == "1" ? "bg-[#088178] text-white" : "bg-white text-black"
          } `}
        >
          1
        </button>
        ...
        <button
          ...
          className={`transition-all duration-300 cursor-pointer rounded-md shadow-lg px-7 py-4 md:px-6 md:py-3 text-xl hover:bg-[#088178] hover:text-[#fff] ${
            isActive == "2" ? "bg-[#088178] text-white" : "bg-white text-black"
          } `}
        >
          2
        </button>
