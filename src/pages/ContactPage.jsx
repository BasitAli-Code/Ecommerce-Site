    ...
    <>
      ...
      <div className="my-10 flex flex-col md:flex-row justify-center items-center gap-8 w-full h-auto">
        ...
        <div className="w-[80%] md:w-[40%]">
          ...
          <p className='mt-3 text-[16px] tracking-wide text-gray-500'>
            <FaMapMarkerAlt className='inline'/> 56 street Main Road Darogawala,Lahore
          </p>            
      ...
      <div className="my-25 flex flex-col md:flex-row justify-center items-center gap-8 w-full h-auto">
        ...
        <div className="my-10 flex flex-col items-start gap-4 w-[90%] md:w-[40%]">
          ...
          <input className='outline-none border border-gray-400 w-[100%] md:w-[90%] rounded-md py-1 px-3' type="text" placeholder='Your name' />
          <input className='outline-none border border-gray-400 w-[100%] md:w-[90%] rounded-md py-1 px-3' type="text" placeholder='E-mail' />
          <input className='outline-none border border-gray-400 w-[100%]  md:w-[90%] rounded-md py-1 px-3' type="text" placeholder='Subject' />
          <textarea name="userMessage" rows="6" cols="64" placeholder="Your Message" className='outline-none w-[100%] md:w-[90%] border border-gray-400 rounded-lg py-2 px-3'></textarea>
          ...
          <div className="flex flex-col items-center gap-3 w-[90%] md:w-[40%]">

            {
              profileImages.map((src , index) => (
                ...
                <div key = {index} className="w-[70%] flex items-center gap-6 justify-center">
                  <img src = {src} alt="person-profile-pic" />
                  <div className="">
                    <p className='tracking-wide text-xl text-black'>
                      John Doe
                    </p>
