...
const CartPage = () => {
  ...
  const { cart , increaseQuantity , decreaseQuantity , addToCart , removeFromCart } = useContext(CartContext);
      ...
      {cart.map((product, index) => (
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-gray-700 font-[500]">{product.quantity}</span>
